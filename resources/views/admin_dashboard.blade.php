...
<div style="height: 73vh;">
    ...
    <div class="dashboard-grid">
        <div class="dashboard-card">
            ...
            <a href="/campus/create">Add Campus</a>
            <a href="/campuses">View Campus</a>
        </div>
        ...
        <div class="dashboard-card">
            ...
            <a href="/departments">View Department</a>
        </div>
        ...
        <div class="dashboard-card">
            ...
            <a href="{{ route('faculties.index') }}">View Faculty</a>

            <!-- <a href="/faculties/create">Add Faculty </a>
            <a href="/faculties">View Faculty</a> -->
        </div>
    </div>
</div>
