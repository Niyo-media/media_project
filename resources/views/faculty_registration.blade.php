...
<head>
    ...
    <script>
        function fetchDepartments() {
            ...
            let facultyDiv = document.getElementById("faculty-form");
...
<div class="container">
    ...
    <form action="{{ route('faculties.store') }}" method="POST" id="faculty-form" class="hidden">
        @csrf
        <input type="hidden" id="department_code" name="department_code" value="{{$department->department_code}}">
        <div class="form-group">
